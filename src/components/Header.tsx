...
export default function Header() {
  ...
  return (
    <header className="shrink-0 z-50 bg-white" role="banner">
      <div className="px-4 py-2 flex items-center justify-between gap-4">
        ...
        <nav
          ref={navContainerRef}
          className="relative flex items-center gap-1 bg-gray-50 rounded-full p-1 shadow-sm ring-1 ring-gray-200/60"
          aria-label={t('aria.mainNavigation')}
        >
          <div
            ref={sliderRef}
            className="absolute top-1 bottom-1 bg-black rounded-full opacity-0"
            style={{
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <Link
                ...
                className={`relative flex items-center gap-2 px-4 py-2.5 rounded-full transition-all duration-200 z-10 ${
                  isActive
