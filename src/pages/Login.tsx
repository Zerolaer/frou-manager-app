...
export default function Login() {
  ...
  return (
    <div className="h-screen flex flex-col md:flex-row bg-white overflow-hidden w-full">
      {/* Левая часть - форма (100% на мобильных, 50% на десктопе) */}
      <div className="w-full md:w-1/2 bg-white flex flex-col justify-center px-4 sm:px-6 md:px-12 lg:px-16 xl:px-20 py-6 sm:py-8 md:py-12 lg:py-0 h-screen md:h-auto overflow-y-auto safe-area-inset">
        <div className="max-w-md mx-auto w-full py-4 sm:py-0">
          {/* Логотип FROVO */}
          <div className="mb-6 sm:mb-8 md:mb-12 lg:mb-16 xl:mb-20">
            <svg 
              ...
              className="w-[90px] h-[20px] xs:w-[100px] xs:h-[22px] sm:w-[110px] sm:h-[24px] md:w-[130px] md:h-[28px]"
              aria-label="FROVO Logo"
            >
          ...
          <div className="mb-5 sm:mb-6 md:mb-7 lg:mb-8">
            ...
            <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-relaxed mt-1">{t('login.subtitle')}</p>
          </div>
          ...
          <div className="flex flex-col xs:flex-row gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-5 md:mb-6">
            <button 
              type="button"
              className="flex-1 flex items-center justify-center gap-2 sm:gap-2.5 md:gap-3 py-2.5 sm:py-3 md:py-3.5 px-3 sm:px-4 md:px-5 border border-gray-300 rounded-xl hover:bg-gray-50 active:bg-gray-100 transition-colors text-xs sm:text-sm md:text-base font-medium min-h-[44px] touch-manipulation"
            ...
            >
              ...
              <span className="text-gray-700 font-medium truncate">Google</span>
            </button>
          </div>
          ...
          {error && (
            <div className="mb-3 sm:mb-4 text-xs sm:text-sm text-red-700 bg-red-50 border border-red-200 rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 break-words">
              {error}
            </div>
          )}
      ...
      <div className="hidden md:flex md:w-1/2 p-4 lg:p-6 xl:p-8 h-screen items-center justify-center bg-gray-50 overflow-hidden flex-shrink-0">
        <div className="relative w-full h-full rounded-[24px] lg:rounded-[32px] overflow-hidden shadow-lg">
          <img 
