...
if (!authChecked) {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="w-full md:w-1/2 bg-white flex flex-col justify-center px-4 sm:px-6 md:px-16 py-8 md:py-0">
        <div className="max-w-md mx-auto w-full">
          {/* Логотип FROVO */}
          <div className="mb-12 md:mb-[120px]">
            <svg width="110" height="24" viewBox="0 0 216 45" fill="none" xmlns="http://www.w3.org/2000/svg" className="md:w-[130px] md:h-[28px]">
          ...
          <div className="mb-6 md:mb-8">
            ...
            <p className="text-sm md:text-base text-gray-600">{t('login.subtitle')}</p>
          </div>

          {/* Социальные кнопки */}
          <div className="flex gap-3 md:gap-4 mb-6">
            <button className="flex-1 flex items-center justify-center gap-2 md:gap-3 py-2.5 md:py-3 px-3 md:px-4 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors text-sm md:text-base">
